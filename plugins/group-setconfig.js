...
let handler = async (m, { conn, command }) => {
    ...
    if (command === 'setabrir' || command === 'setcerrar') {
        if (!m.quoted) return m.reply('😼🍕 Responde a un sticker con .setabrir o .setcerrar - Lu Bot quiere su sticker pe')
        try {
            let q = m.quoted
...
😼 Lu Bot tiró el sticker a la basura, configura uno nuevo pe
